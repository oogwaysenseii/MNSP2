...
export function BlogCTA() {
  return (
    <div className="bg-zinc-950 text-white  p-8 sm:p-12 mt-16 text-center shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <Link
          href="/kontakt"
          className="inline-block px-8 py-4 bg-amber-500 hover:bg-amber-400 text-zinc-950 text-sm font-bold uppercase tracking-widest  transition-colors cursor-pointer shadow-lg hover:shadow-amber-500/20"
        >
