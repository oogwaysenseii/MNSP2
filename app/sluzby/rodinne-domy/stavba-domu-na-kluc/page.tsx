  ...
  const whyUsSection = (
      <div className="bg-white border border-zinc-200 p-8 sm:p-10 text-center h-full flex flex-col justify-center space-y-6">
        ...
        <p className="text-zinc-600 text-sm leading-relaxed max-w-md mx-auto">
          Stavba domu by nemala byť stresom, ale radostným očakávaním. V MNSP sme priamo zhotoviteľmi stavieb. Máme vlastných majstrov, vlastné technológie a na rozdiel od sprostredkovateľských firiem dokážeme priamo kontrolovať každý detail stavby a ručiť za dohodnutý rozpočet. Zabezpečujeme kvalitnú a precíznu prácu, na ktorú sa môžete dlhé roky spoľahnúť.
        </p>
      </div>
  );
