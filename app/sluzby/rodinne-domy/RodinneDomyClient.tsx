          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            <div className="bg-white border border-zinc-200 p-8 sm:p-10 text-center h-full flex flex-col justify-center space-y-6">
              ...
              <p className="text-zinc-600 text-sm leading-relaxed max-w-md mx-auto">
                Realizácia rodinného domu si vyžaduje skúsenosti, odborný prístup a zodpovednosť. Sme priamo zhotovitelia s vlastným tímom a technikou, vďaka čomu minimalizujeme subdodávky, dokážeme garantovať termíny a udržať vysokú kvalitu stavebných prác. Postavíme váš dom spoľahlivo a bez kompromisov.
              </p>
            </div>
