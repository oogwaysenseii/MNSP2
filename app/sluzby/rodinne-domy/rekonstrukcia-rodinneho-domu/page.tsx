  ...
  const whyUsSection = (
      <div className="bg-white border border-zinc-200 p-8 sm:p-10 text-center h-full flex flex-col justify-center space-y-6">
        ...
        <p className="text-zinc-600 text-sm leading-relaxed max-w-md mx-auto">
          Pri rekonštrukciách starých domov na vás číha množstvo prekvapení a skrytých závad. Zveriť takúto prácu partii neskúsených majstrov sa často končí katastrofou. V MNSP máme bohaté skúsenosti so sanáciami, poznáme materiály používané v minulosti a vieme ich správne nakombinovať s modernými technológiami. Sme stabilným a zodpovedným partnerom pre vašu stavbu.
        </p>
      </div>
  );
