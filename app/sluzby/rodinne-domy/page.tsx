...
import { Home, Hammer, ArrowRight, ShieldCheck, HardHat, CheckCircle2 } from 'lucide-react';
...
export default function Page() {
  const jsonLd = [
    ...
    generateServiceSchema(TITLE, DESCRIPTION, `${DOMAIN}/sluzby/rodinne-domy`),
  ];
      ...
      <div className="relative h-[50vh] min-h-[440px] bg-zinc-950 text-white overflow-hidden flex items-end">
        ...
        <div className="max-w-[1500px] relative z-10 w-full mx-auto px-6 pb-14 pt-28 space-y-4">
          ...
          <p className="max-w-2xl text-zinc-300 text-sm md:text-base leading-relaxed">
            Od výstavby nových domov až po kompletné rekonštrukcie poskytujeme kvalitné
            remeselné spracovanie a riešenia na mieru.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1500px] mx-auto px-6 mt-10 mb-10">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-10">
          ...
          <p className="text-zinc-600 leading-relaxed">
            Staviame nové rodinné domy a rekonštruujeme tie existujúce. Spájame kvalitné
            stavebné riešenia, spoľahlivú realizáciu a dôraz na dlhodobú spokojnosť klientov.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <Link href="/sluzby/rodinne-domy/stavba-domu-na-kluc" className="group">
            <FadeInCard index={0} variant="bare">
              <div className="h-64 relative overflow-hidden bg-zinc-950">
                <Image
                  src="/rodinne-domy/stavba-domu-na-kluc.webp"
                  alt="Rodinný dom vo výstavbe — hrubá stavba pripravená na strechu"
                  fill
          ...
          <Link href="/sluzby/rodinne-domy/rekonstrukcia-rodinneho-domu" className="group">
            <FadeInCard index={1} variant="bare">
              <div className="h-64 relative overflow-hidden bg-zinc-950">
                <Image
                  src="/rodinne-domy/rekonstrukcia-rodinneho-domu.webp"
                  alt="Rodinný dom počas rekonštrukcie — zateplenie fasády a stavebné práce"
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                  className="object-cover object-[center_70%] opacity-80 group-hover:scale-105 transition-transform duration-700"
                />
        ...
        <div className="max-w-[1500px] mx-auto px-6 space-y-12">
          <div className="space-y-4 ">
            ...
            <p className="text-zinc-700 leading-relaxed text-sm sm:text-base">
              Jadrom našej praxe v oblasti rodinných domov je odhodlanie poskytovať
              technickú dokonalosť a prvotriedne remeselné spracovanie. Či už staviate od
              základov alebo kompletne rekonštruujete starší dom, zabezpečujeme hladký
              priebeh stavebných prác, dodržanie rozpočtu a použitie kvalitných materiálov.
              Veríme, že skutočná kvalita spočíva v detailoch, ktoré na prvý pohľad nevidno:
              v tepelnej izolácii bez mostov, v precíznosti rozvodov a v statickej stabilite
              vašej stavby.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 border border-zinc-200 shadow-sm space-y-3">
              ...
              <p className="text-zinc-600 text-xs leading-relaxed">
                K rodinným domom pristupujeme s rovnakými statickými kritériami ako
                k väčším projektom. Kvalitná výstuž, správna trieda betónu a precízne
                tesárske práce zaisťujú dlhodobú stabilitu.
              </p>
            </div>
            <div className="bg-white p-6 border border-zinc-200 shadow-sm space-y-3">
...
Stavba či rekonštrukcia rodinného domu si vyžaduje skúsenosti, odborný
                prístup a zodpovednosť. Postavíme váš dom spoľahlivo a bez starostí.
              </p>
            </div>
